 ...
 */
class OneOffCommand extends UserCommand
{
    /**
     * @var string
     */
    protected $name = 'oneOff';

    /**
     * @var string
     */
    protected $description = 'Выключение первого клапана';

    /**
     * @var string
     */
    protected $usage = '/oneOff';
