...
@section('title', 'Secure CRUD (CREATE)')
...
@section('content')
    ...
    <div class="row">
        ...
        <section class="col-lg-6 connectedSortable">
            ...
            <div class="card">
                <form method="post" action="{{ route('secure.store') }}">
                <div class="card-header">
                    <h3 class="card-title">
                        <i class="ion ion-clipboard mr-1"></i>
                        Добавление Датчика Охраны
                    </h3>
                ...
                <div class="card-body">
                    ...
                    @endif
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="current_command" autocomplete="off" value="{{ old('current_command') }}" />
                            </div>
                            <div class="form-group">
                ...
                <div class="card-footer clearfix">
                    <a class="btn btn-info" href="{{ route('secure.index') }}">К списку Реле</a>
                    <button type="submit" class="btn btn-info float-right"><i class="fas fa-plus"></i> Добавить Датчик</button>
                </div>
                </form>
            </div>
            <!-- /.card -->
